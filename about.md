...
<div class="max-w-xl mx-auto text-center">
  ...
  <div class="pb-6 px-6">
    <ul class="flex justify-center space-x-5">
      ...
      {% if site.social_media.email %}
        <li><a href="mailto:{{ site.social_media.email }}" class="text-gray-600 hover:text-indigo-600">
      ...
      {% if site.social_media.linkedin %}
        <li><a href="https://linkedin.com/in/{{ site.social_media.linkedin }}" class="text-gray-600 hover:text-blue-700" target="_blank" rel="noopener">
          <svg class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v32.8h1.3c12.4-20.8 42.69-41.5 88.58-41.5 93.79 0 111.1 61.9 111.1 142.3V448z"/>
          </svg>
        </a></li>
      {% endif %}
      
      {% if site.social_media.github %}
        <li><a href="https://github.com/{{ site.social_media.github }}" class="text-gray-600 hover:text-gray-900" target="_blank" rel="noopener">
      ...
      {% if site.social_media.youtube %}
        <li><a href="https://youtube.com/@{{ site.social_media.youtube }}" class="text-gray-600 hover:text-red-600" target="_blank" rel="noopener">
      ...
      {% if site.social_media.twitter %}
        <li><a href="https://twitter.com/{{ site.social_media.twitter }}" class="text-gray-600 hover:text-blue-500" target="_blank" rel="noopener">
          <svg class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      {% if site.social_media.instagram %}
        <li><a href="https://instagram.com/{{ site.social_media.instagram }}" class="text-gray-600 hover:text-pink-600" target="_blank" rel="noopener">
          <svg class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
